...
func MetaIsNil() predicate.Tenant {
	return predicate.Tenant(sql.FieldIsNull(FieldMeta))
}

// MetaNotNil applies the NotNil predicate on the "meta" field.
func MetaNotNil() predicate.Tenant {
	return predicate.Tenant(sql.FieldNotNull(FieldMeta))
}
