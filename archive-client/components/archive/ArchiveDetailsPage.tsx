  ...
  return (
    <>
      ...
      <div className="flex gap-4 items-center mb-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">post title here</h1>
          <div className="text-sm text-muted-foreground">17 May 2025</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
        ...
        <div className="lg:col-span-3">
          <Card>
            <CardContent className="p-6 shadow-0 rounded-sm">
        ...
        <div className="sticky top-43 h-fit ">
          <AuthorInformation />
        </div>
      </div>
    </>
